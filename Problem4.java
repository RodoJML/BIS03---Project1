...
public class Problem4 
{
    ...
    private void merge(long array[], int start, int end)
    {
        ...
        int indexNew    = start;                                    // This will be used as index pointer for the new temporary array 
        
        
        while(indexStart0 <= indexMiddle && indexStart1 <= end)     // This is a validation, we are not comparing values of the string, just the pointers
        {
